...
-- remove_hotkey_string_pair_by_id(hotkey_string_combination_id)!
-- Removes hotkey <String>, string <String> pair by id
DELETE FROM hotkey_string_combinations
WHERE hotkey_string_combinations_id = :hotkey_string_combinations_id
...
REPLACE INTO speed_detection (info, detected_at)
...
REPLACE INTO blacklist_detection (hotkey_id, detected_at)
...
REPLACE INTO blacklist_detection (string_id, detected_at)
...
REPLACE INTO blacklist_detection (pair_id, detected_at)
